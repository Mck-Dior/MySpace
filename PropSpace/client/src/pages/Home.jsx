    ...
    <div className="card glass">
        ...
        <div style={{ padding: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.5rem' }}>
                ...
                <span style={{ background: 'rgba(59, 130, 246, 0.15)', color: 'var(--primary)', padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.875rem' }}>
    ...
    return (
        <div style={{ paddingBottom: '4rem' }}>
            ...
            <div style={{
                ...
                backgroundImage: 'linear-gradient(to bottom, rgba(9, 9, 11, 0.4), #09090b), url("/hero-bg.png")',
