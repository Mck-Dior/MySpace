                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div>
                        ...
                        {totalImages < 6 && (
                            ...
                            >
                                <ImagePlus size={36} style={{ color: dragActive ? '#10b981' : '#64748b', marginBottom: '0.75rem' }} />
                                <p style={{ fontWeight: '600', marginBottom: '0.25rem', color: dragActive ? '#10b981' : '#e2e8f0' }}>
                                ...
                                {formData.imageUrls.map((url, i) => (
                                    <div key={`existing-${i}`} style={{ position: 'relative', borderRadius: '0.5rem', overflow: 'hidden', aspectRatio: '1', border: '1px solid #334155' }}>
                                        ...
                                        <span style={{
                                            ...
                                            background: 'rgba(16,185,129,0.8)', color: '#fff', fontSize: '0.65rem',
